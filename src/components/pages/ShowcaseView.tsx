        ...
        <div className="w-full h-full relative">
            <div className="flex flex-col h-full w-full absolute justify-between">
                ...
                <div className="flex-row gap-2 justify-between hidden md:flex items-center md:pb-20 md:pr-20">
                    <MagicIcon IconComponent={ArrowLeftIcon} clickable fillCurrent className="h-5" onClick={ (posts && posts.length > 0) ? () => {
                    ...
                    <MagicIcon IconComponent={ArrowRightIcon} clickable fillCurrent className="h-5" onClick={ (posts && posts.length > 0) ? () => {
