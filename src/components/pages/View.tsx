...
function View({ ...props}) {
    ...
    return (
        <div className='absolute w-full h-full'>
            ...
            <div className="absolute w-full h-full md:p-8">
                <div className="md:border rounded-3xl w-full h-full p-8">
                    <MagicDiv className="flex flex-row mb-4 justify-between md:justify-start">
                        ...
                        <MagicButton className="h-9 md:h-12 ml-auto" onClick={()=>{navigate(`/browse/${id}`)}} languageSpecificChildren={{en: "back", zh: "返回"}}/>
                    </MagicDiv>
                </div>
            </div>
        </div>
