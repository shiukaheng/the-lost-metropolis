        ...
        <GenericPage className="relative w-full h-full overflow-x-hidden flex flex-col gap-4">
            <HighlightViewport className="absolute w-full h-full overflow-hidden flex-grow">
                <Suspense fallback={<TestObject/>}>
                    <DepthKitObject position={[-0.75, 1.1, 1.85]} scale={[0.001, 0.001, 0.001]} videoUrl={process.env.PUBLIC_URL + "/depthkit/Chae_Demo_Upres.webm"} metaUrl={process.env.PUBLIC_URL + '/depthkit/Chae_Demo_Upres.txt'} posterUrl={process.env.PUBLIC_URL + '/depthkit/Chae_Demo_Upres.png'}/>
                </Suspense>
