...
export const sourceAssetLiteral = nullable_tuple("Potree2", "Audio", "DepthKitVideo", "Image", "Nexus")
...
export const targetAssetLiteral = nullable_tuple("Potree2", "Audio", "DepthKitVideo", "Image", "Nexus")
