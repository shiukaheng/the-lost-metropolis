...
export const componentLiteral = tuple("DebugPlane", "DepthKitObject", "InfoObject", "LinkObject", "PotreeObject", "TestObject", "PotreeAssetObject", "NexusObject", "NexusAssetObject")
